      ...
      <section id="hero" className="text-white lg:h-[100vh] lg:p-20 p-6 sm:py-16">
        ...
        <div className="lg:flex mt-10">
          ...
          <button className="flex p-4 sm:w-full sm:mt-4 justify-center rounded-md border border-white border-b-4 px-10">
            <a href="https://docs.google.com/forms/u/2/d/e/1FAIpQLSf2qg4pHn7nV0dyN9QREdeX1jE32Vznig-Xa3LPDhYgByxaOg/viewform?usp=send_form" target="_blank">
              <p className="mr-2 my-auto">Become a Sponsor</p></a>
