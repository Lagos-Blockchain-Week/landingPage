...
function ProgramTrack() {
  return (
    <div className=" lg:mx-[50px] mx-4 mt-[100px] text-white flex flex-col">
      <p className='text-[30px]'>2024 Program Tracks</p>

      {/* 1 */}
      <div className="flex flex-wrap gap-y-[60px]  md:gap-x-[60px] md:grid-cols-3 mt-6">
        ...
        <div className="box lg:ml-44 flex flex-col p-8 gap-y-6 col-span-2 border-solid border-2 rounded border-blue px-4">
        ...
        <div className="lg:mt-[60px] md:mt-[0] box flex flex-col p-8 gap-y-6 col-span-2 border-solid border-2 rounded border-blue px-4 bg-gradient-to-br from-opacity-50 via-opacity-25 to-opacity-15">
          <p>Corporate Web3</p>
          <img src="./images/line.png" />
          <div className="flex items-center">
            {" "}
