    ...
    <Fragment>
      ...
      <div className="mt-[100px] relative">
        ...
        <div className="flex justify-between absolute lg:top-40 top-10 my-auto lg:left-20 left-5 lg:right-20 right-5">
          <p className="text-white font-bold my-auto text-sm lg:text-5xl">Join us from May 2<sup>nd</sup> - 11<sup>th</sup>, 2024, at <br /> The Raddison Blue Hotel,Ikeja - Lagos.</p>
